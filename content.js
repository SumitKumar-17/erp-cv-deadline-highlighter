...
const CONFIG = {
    ...
    endNumber: 600,
    colors: {
        upcoming: rgb(0, 255, 8),   // Green for upcoming deadlines
        overdue: rgb(255, 0, 0),   // Strong Red for overdue deadlines
        warning: rgb(255, 166, 0),   // Amber/Orange for soon-to-expire
        border: '#ffffff'    // White for borders
